...
public class VehicleAssembler implements Assembler {
    ...
    public double getTotalWeight() {
        return this.arsenalParts.stream().mapToDouble(attackModifyingPart -> attackModifyingPart.getWeight()).sum()
                + this.shellParts.stream().mapToDouble(defenseModifyingPart -> defenseModifyingPart.getWeight()).sum()
                + this.enduranceParts.stream().mapToDouble(hitPointsModifyingPart -> hitPointsModifyingPart.getWeight()).sum();
    }
